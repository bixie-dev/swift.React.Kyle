...
export const Receive: React.FC<PageProps> = (): JSX.Element => {
  ...
  return (
    <div className='Receive'>
      <div className="Receive_dashboard">
        <Image src={BackImg} className="Receive_dashboard_BackImg" />
      ...
      <div className='Receive_getting-start d-flex'>
        <div className="Receive_getting-start_content px-5" style={{backgroundColor: "#151515"}}>
      ...
      <div className='Receive_getting-start'>
        <Row className="">
          <Col className='px-5' xl={5}>
            <Image src={BackImg10} width={350} />
          </Col>
          <Col xl={7} className="text-start mt-5 py-5 px-5">
